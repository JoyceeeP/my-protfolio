...
const Contact = () => {
  return (
    ...
    //             {/* Facebook */}
    //             <div className='mb-4 mt-8'>
    //                 <FaFacebook className='inline-block text-[#DA498D] mr-2'></FaFacebook>
    //                 <a href="https://facebook.com/JoycePeneira.me" className='hover:underline'>
    //                     Joyce Peneira
    //                 </a>
    //             </div>
    //             {/* Instagram */}
    //             <div className='mb-4 mt-8'>
    //                 <FaInstagram className='inline-block text-[#DA498D] mr-2'></FaInstagram>
    //                 <a href="https://www.instagram.com/joyceee__chan" className='hover:underline'>
    //                     Joyce Peneira
    //                 </a>
    //             </div>
    //             {/* LinkedIn */}
    //             <div className='mb-4 mt-8'>
    //                 <FaLinkedin className='inline-block text-[#DA498D] mr-2'></FaLinkedin>
    //                 <a href="https://linkedin.com/in/Joycelyn_Peneira" className='hover:underline'>
    //                     Joycelyn Peneira
    //                 </a>
    //             </div>
    ...
    <div className="bg-black text-white py-20" id="about">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        <h2 className="text-4xl font-bold text-center mb-12 text-[#F9E6CF]">Reach Me Out</h2>
